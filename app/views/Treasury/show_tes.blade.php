	...
	<div class="content">
	    <div class="col-md-12" style="">
	        ...
	        <div class="panel panel-default">
	            <div class="panel-heading"><h3 class="panel-title">Solicitudes a Depositar</h3><small style="float: right; margin-top: -10px"><strong>Usuario : Tesorería</strong></small></div>
