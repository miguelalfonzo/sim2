        ...
        if (!empty($date))
        {
            ...
            if ($rpta[status] == ok)
            {
                ...
                if ($rpta[status] == ok)
                {
                    ...
                    {
                        $soles = $rpta[data]->sum( function( $solicitud )
                        {
                        ...
                        $dolares = $rpta[data]->sum( function( $solicitud )
                        {
                            $deposito = $solicitud->detalle->deposit;
                            $moneda = $deposito->account->typeMoney;
                    ...
                    $rpta = $this->setRpta( array( 'View' => $view , 'Total' => array( 'Soles' => $soles , 'Dolares' => $dolares ) ) );                
                }
            }
    	}
        else
