...
$(function(){
    ...
    //Events: Datepicker, Buttons, Keyup.
        ...
        $(document).on("click","#table-expense .edit-expense",function(e){
            ...
            data = {"ruc":ruc,"number_voucher":voucher_number};
            $.ajax({
                type: 'get',
        ...
        $("#save-expense").on("click",function(e){
            ...
            else
            {
                ...
                if(error_json === 0)
                {
                    ...
                    if(typeof row_expenses != "undefined")
                    {
                        console.log(calculateTot(row_expenses,'.total_expense'));
                        if(tot_rows>0)
                        {
                            validateRuc(ruc);
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $.each(rows,function(index){
                                            if($(this).find(".voucher_number").html()===number_voucher)
                                            {
